...
class MainPage:
    def __init__(self, browser):
        ...
        self._first_name, self._last_name, self._address, self._email, self._phone, self._zip_code, \
            self._city, self._country, self._job_position, self._company, self._button = None
    ...
    #
    # def getting_class_address(self):
    ...
    #
    # def getting_class_job_position(self):
